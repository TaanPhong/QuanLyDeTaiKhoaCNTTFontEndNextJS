...
import { SidebarDataChair } from "@/data/DataSideBar"
import TableChair from '@/components/table/TableChairResearch';
            ...
            axios.post("http://localhost:8081/research/update/revise/" + status + "/" + context.account?.username, selected)
                .then((res) => {
                    if (status == 4) {
                        ...
                        toast.success("Đề tài đã được yêu cầu chỉnh sửa")
                    }
                    else {
                        toast.success("Đề tài đã có thể được giao cho sinh viên")
                    }
                    setChange(!change)
                    setSelected([])
                })
            ...
            <div className={styles.right}>
                <div className={styles.top}>
                    ...
                    <div className={styles.topRight}>
                        <div>
                            <button className={styles.button} onClick={() => handleOnClickRevise(9)}>
