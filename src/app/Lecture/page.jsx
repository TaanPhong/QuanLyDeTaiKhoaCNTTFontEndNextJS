...
import { SidebarDataLecture } from "@/data/DataSideBar"
        ...
        <Container className={styles.container}>
            <div className={styles.left}>
                ...
                <div className={styles.sidebar}>
                    {
                        SidebarDataLecture.map((item, index) => {
                            return (
                                <div className={styles.menuItem}>
                                    <item.icon className={index === 0 ? styles.active : ""} />
                                    <span className={index === 0 ? styles.active : ""}>{item.heading}</span>
                                </div>
                            )
                        })
                    }
